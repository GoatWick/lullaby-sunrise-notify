...
const Index = () => {
  return (
    <div className="min-h-screen w-full relative flex flex-col items-center justify-center bg-lullaby-purple overflow-hidden px-4">
      <StarBackground />
      
      <main className="z-10 flex flex-col items-center justify-center w-full max-w-4xl mx-auto py-16 text-center">
        <MoonLogo />
        
        <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl font-bold mt-8 mb-4 text-lullaby-cream">
          Lullaby Lounge
        </h1>
        ...
        <div className="mt-16 flex flex-col gap-2">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <div className="w-2 h-2 bg-lullaby-cream rounded-full animate-pulse" style={{ animationDelay: "0.3s" }}></div>
            <div className="w-2 h-2 bg-lullaby-cream rounded-full animate-pulse" style={{ animationDelay: "0.6s" }}></div>
          </div>
        </div>
      </main>
